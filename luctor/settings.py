...
ALLOWED_HOSTS = ["kookboot.com", "www.kookboot.com", "localhost", "127.0.0.1"]
CSRF_TRUSTED_ORIGINS = ["https://kookboot.com", "https://www.kookboot.com"]
...
LOGGING = {
    ...
    "formatters": {
        "verbose": {"format": "[%(asctime)s %(module)s %(levelname)s] %(message)s"},
    },
}
